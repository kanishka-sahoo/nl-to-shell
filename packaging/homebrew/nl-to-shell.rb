class NlToShell < Formula
  ...
  homepage "https://github.com/kanishka-sahoo/nl-to-shell"
  url "https://github.com/kanishka-sahoo/nl-to-shell/releases/download/0.1.0-dev/nl-to-shell-darwin-amd64.tar.gz"
  ...
  on_arm do
    url "https://github.com/kanishka-sahoo/nl-to-shell/releases/download/0.1.0-dev/nl-to-shell-darwin-arm64.tar.gz"
